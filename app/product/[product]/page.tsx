      ...
      return (
        <div className=" mt-16 max-w-7xl mx-auto">
           ...
           <SinglepageImage SinglepageImage={singleProducts.singleProduct} />
            ...
            <div className="w-96 border rounded px-3 py-1">
              <div className="flex justify-between">
                <div>
                  <h1 className="text-xl font-medium">{singleProducts.singleProduct.name && singleProducts.singleProduct.name} </h1>
                  <h2 className="text-2xl font-medium flex  items-center">
                    {" "}
                    <PiCurrencyInr size={27} /> {singleProducts.singleProduct.newPrice}{" "}
                    <span className="ml-4 text-xl mt-1 line-through text-gray-400">
                      {" "}
                      {"<--"} <span className="ml-2"></span> {singleProducts.singleProduct.oldPrice}{" "}
                    </span>
                    <span className="ml-4 text-xl mt-1  text-gray-400">
                      {" "}
                      oFF <span className="ml-2"></span> {(Number(singleProducts.singleProduct.oldPrice)-Number(singleProducts.singleProduct.newPrice))/Number(singleProducts.singleProduct.oldPrice)*100} %{" "}
                    </span>
                  </h2>
              ...
              <div className="themeColor1 py-5 mt-3">
                <p className="text-center  text-white  font-thin tracking-widest text-xl"> {singleProducts.singleProduct.extraOffer}% Off Extra</p>
              </div>
              <div className="">
                <Quentity />
              </div>
          ...
          <ul className="flex gap-3  justify-center mt-5 text-xl">
            <p className="text-gray-600">Brand :  <span className="themeColor1 drop-shadow  shadow text-white text-shadow border border-dashed border-white px-3 py-1"> {singleProducts.singleProduct.brand && singleProducts.singleProduct.brand} </span>  </p>
            <p className="text-gray-600">Country :  <span className="themeColor1 drop-shadow  shadow text-white text-shadow border border-dashed border-white px-3 py-1"> {singleProducts.singleProduct.country && singleProducts.singleProduct.country} </span>  </p>
            ...
            <p className="text-gray-600">Life Cycle :  <span className="themeColor1 drop-shadow  shadow text-white text-shadow border border-dashed border-white px-3 py-1">{singleProducts.singleProduct.lifeCycle && singleProducts.singleProduct.lifeCycle} </span>  </p>
          ...
          <p className="mt-3 text-gray-600"> {singleProducts.singleProduct.description && singleProducts.singleProduct.description}  </p>
          </div>
